...
public class AuthenticationTest {
    ...
    @Test
    @DisplayName("Should successfully login with exist user")
    void shouldLoginIfRegisteredAndActiveUser() {
    ...
    @Test
    @DisplayName("Should get an error message if login with not registered user")
    ...
    @Test
    @DisplayName("Should get an error message if login with blocked registered user")
    ...
    @Test
    @DisplayName("Should get error message if user login with wrong name")
    void shouldGetErrorIfUserUseWrongLogin() {
        var registeredUser = getRegisteredUser("active");
    ...
    @Test
    @DisplayName("Should get error message if user login with wrong name")
    void shouldGetErrorIfUserUseWrongPassword() {
        var registeredUser = getRegisteredUser("active");
